...
public class OperationService {
	...
	// Récupère la liste des opérations effectuées par un utilisateur donné
	...
	// Récupère la liste des opérations effectuées par un utilisateur donné sous
	// forme de DTO
	...
	// Convertit une liste d'entités Operation en une liste de DTO OperationDTO
