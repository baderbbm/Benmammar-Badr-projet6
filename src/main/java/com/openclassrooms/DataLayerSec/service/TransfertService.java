...
public class TransfertService {
	...
	// Récupère la liste des transferts effectués par un utilisateur émetteur donné
	public List<Transfert> getVirementsByUtilisateurEmetteur(UtilisateurDTO utilisateurEmetteurDTO) {
		Utilisateur utilisateurEmetteur = utilisateurService
				.findByAdresseEmail(utilisateurEmetteurDTO.getAdresseEmail());
	...
	// Convertit une liste d'entités Transfert en une liste de DTO TransfertDTO
